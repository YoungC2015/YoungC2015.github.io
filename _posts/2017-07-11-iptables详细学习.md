...
```
iptables -t nat -A PREROUTING --destination 191.101.9.212 -p tcp --dport 2122 -j DNAT --to 143.248.249.64:2222
iptables -t nat -A POSTROUTING -d 143.248.249.64 --dport 2222 -p tcp -j SNAT --to 191.101.9.212
```
